...
namespace FocLauncherHost.Controls
{
    ...
    {
        public enum OutlinedTextBlockStrokePosition
        {
            Center,
            Outside,
            Inside
        ...
        public static readonly DependencyProperty StrokePositionProperty =
            DependencyProperty.Register("StrokePosition", typeof(OutlinedTextBlockStrokePosition), typeof(OutlinedTextBlock),
                new FrameworkPropertyMetadata(OutlinedTextBlockStrokePosition.Outside, FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty FillProperty = DependencyProperty.Register("Fill", typeof(Brush),
            typeof(OutlinedTextBlock), new FrameworkPropertyMetadata(Brushes.Black, FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty StrokeProperty = DependencyProperty.Register("Stroke",
            typeof(Brush), typeof(OutlinedTextBlock), new FrameworkPropertyMetadata(Brushes.Black, FrameworkPropertyMetadataOptions.AffectsRender));
        ...
        public static readonly DependencyProperty FontStyleProperty = TextElement.FontStyleProperty.AddOwner(
            typeof(OutlinedTextBlock), new FrameworkPropertyMetadata(OnFormattedTextUpdated));
        ...
        public static readonly DependencyProperty TextDecorationsProperty = DependencyProperty.Register("TextDecorations",
            typeof(TextDecorationCollection), typeof(OutlinedTextBlock), new FrameworkPropertyMetadata(OnFormattedTextUpdated));

        public static readonly DependencyProperty TextTrimmingProperty = DependencyProperty.Register("TextTrimming", 
            typeof(TextTrimming), typeof(OutlinedTextBlock), new FrameworkPropertyMetadata(OnFormattedTextUpdated));

        public static readonly DependencyProperty TextWrappingProperty = DependencyProperty.Register("TextWrapping",
            typeof(TextWrapping), typeof(OutlinedTextBlock),
            new FrameworkPropertyMetadata(TextWrapping.NoWrap, OnFormattedTextUpdated));

        public OutlinedTextBlockStrokePosition StrokePosition
        {
            get => (OutlinedTextBlockStrokePosition)GetValue(StrokePositionProperty);
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            {
                case OutlinedTextBlockStrokePosition.Outside:
                    drawingContext.PushClip(_clipGeometry);
                    break;
                case OutlinedTextBlockStrokePosition.Inside:
                    drawingContext.PushClip(_textGeometry);
                    break;
            }
            drawingContext.DrawGeometry(null, _pen, _textGeometry);

            if (StrokePosition == OutlinedTextBlockStrokePosition.Outside || StrokePosition == OutlinedTextBlockStrokePosition.Inside)
                drawingContext.Pop();
        }
        ...
        private void EnsureGeometry()
        {
            ...
            if (StrokePosition == OutlinedTextBlockStrokePosition.Outside)
            {
